...
# for tree in "orig"; do
    ...
    # for adpt in "agg" "agg2"; do
        ...
        Rscript eval_scripts/cp_go_get_enrichment.R ${result_path}${tree}/gene_lists/adpt_${adpt}/gene_info.csv ${ref_gene_list} ${result_path}${tree}/gene_lists/adpt_${adpt}/cp_go.csv
    done
done