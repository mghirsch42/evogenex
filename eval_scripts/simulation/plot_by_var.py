...
sim_data = "adpt" # neut, const, or adpt
regime = "adpt" # const or adpt
results_folder = "results/simulated/{}_sim_{}_run/".format(sim_data, regime)
save_folder = "figures/simulation/{}_sim_{}_run/".format(sim_data, regime)


groupby_var = "sigma_sq" # sigma_sq, alpha, r or theta_ratio
